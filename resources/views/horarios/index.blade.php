    ...
    <div class="col-md-12">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb pl-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Agregar Horario</li>
            </ol>
        </nav>
    </div>
                    ...
                    <div class="ms-card-body">
                        <div class="media fs-14">
                            ...
                            <div class="media-body">
                                ...
                                <p class="fs-12 my-1 text-disabled">Dentista</p>
                                <h6 class="mt-2"><span><i class="far fa-calendar"></i></span> 21 Jan 2019</h6>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="ms-card-body">
                        <div class="media fs-14">
                            ...
                            <div class="media-body">
                                ...
                                <p class="fs-12 my-1 text-disabled">Dentista</p>
                                <h6 class="mt-2"><span><i class="far fa-calendar"></i></span> 25 Jan 2019</h6>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="ms-card-body">
                        <div class="media fs-14">
                            ...
                            <div class="media-body">
                                ...
                                <p class="fs-12 my-1 text-disabled">dentista</p>
                                <h6 class="mt-2"><span><i class="far fa-calendar"></i></span> 22 Jan 2019</h6>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="ms-card-body">
                        <div class="media fs-14">
                            ...
                            <div class="media-body">
                                ...
                                <p class="fs-12 my-1 text-disabled">Dentista</p>
                                <h6 class="mt-2"><span><i class="far fa-calendar"></i></span> 19 Jan 2019</h6>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-xl-12 col-md-12">
        <div class="ms-panel">
            <div class="ms-panel-header  ms-panel-custome">
                <h6>Agregar Horario</h6>
                <a href="schedule-list.html" class="ms-text-primary">Lista de Horarios</a>
            </div>
            <div class="ms-panel-body">
                <form class="needs-validation" novalidate="">
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                            <label for="validationCustom001">Odontologo</label>
                            <div class="input-group">
                            <select class="form-control" id="validationCustom002" required="">
                                    <option value="">Cristina Groves</option>
                                    
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6 mb-2">
                            <label for="validationCustom004">Tiempo Disponible</label>
                            <div class="input-group">
                                <input type="text" class="form-control" id="validationCustom004" placeholder="Tiempo Disponible" required="">
                    ...
                    <div class="form-row">                        
                        <div class="col-md-6 mb-3">
                            <label for="validationCustom002">Dias disponibles</label>
                            <div class="input-group">
                                <select class="form-control" id="validationCustom002" required="">
...
/*
Template Name: Mednalytics - Multipurpose Bootstra 4 Medical Dashboard
Version: 1.0.0
*/
/*===========================
 =  Table of Contents
